...
{Fore.CYAN}Example:{Style.RESET_ALL}
    python tool.py -u https://example.com/FUZZ -w ./wordlist.txt -t 120 -s 403,503,421 -th 20
"""
    print(help_text)
...
def brute_force(base_url, wordlist, wait_time=320, silent_codes=None, threads=50):
...
if __name__ == "__main__":
    ...
    if args.help:
        ...
        if not wordlist:
            ...
            # Start brute-forcing
            brute_force(args.url, wordlist, args.time, silent_codes, args.threads)
